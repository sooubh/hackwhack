...
<head>
    <meta charset="UTF-8">
    <title>Vigilance AI — Report ${reportId}</title>
    <style>
...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr><td class="label">Platform</td><td>Vigilance AI — India Operations</td></tr>
        </table>
    </div>

    <div class="footer">
        <p>This report was auto-generated by Vigilance AI Supply Chain Management Platform.</p>
        <p style="margin-top: 4px;">© 2024 Vigilance AI — Confidential</p>
    </div>
